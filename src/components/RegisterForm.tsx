        ...
        {!registrationResponse ? (
          ...
          >
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="flex flex-col disabled:scale-100 disabled:bg-transparent disabled:cursor-none justify-center items-center h-[50px] bg-white p-2 border-2 border-black rounded-lg w-1/2 text-black m-auto hover:bg-gray-700 hover:scale-110 hover:text-white duration-150 cursor-pointer mt-1 mb-3"
            >
